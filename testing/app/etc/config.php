...
return [
    'modules' => [
        ...
        'Belvg_AffiliateProgram' => 1,
        'Ludxb_Continueshopping' => 1,
        'Belvg_CountryCodes' => 1,
        'Firas_DonationProduct' => 1,
        'Belvg_LoggedCustomer' => 1,
        'Belvg_MenuAdditional' => 1,
        'Belvg_Products' => 1,
        'Belvg_QuickView' => 1,
        'Dynamic_Mytickets' => 1,
        'Belvg_StoresManager' => 1,
        'Belvg_TicketsList' => 1,
        ...
        'LuxuryUnlimited_Catalog' => 1,
        'LuxuryUnlimited_Checkout' => 1,
        ...
        'LuxuryUnlimited_DeviceDetection' => 1,
