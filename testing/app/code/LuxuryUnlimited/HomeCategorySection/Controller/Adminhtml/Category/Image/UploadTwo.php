 ...
 */
class UploadTwo extends \Magento\Backend\App\Action
{
    /**
    ...
    {
        return $this->_authorization->isAllowed('LuxuryUnlimited_HomeCategorySection::category');
    }
    ...
    public function execute()
    {
        ...
        try {
            $result = $this->imageUploader->saveFileToTmpDir('section_two_image');
            $result['cookie'] = [
