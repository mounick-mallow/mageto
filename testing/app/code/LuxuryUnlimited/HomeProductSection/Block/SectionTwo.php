...
class SectionTwo extends \Magento\Catalog\Block\Product\ListProduct
{
     ...
     * @return array
     */
    public function getSectionTwoProductCollection()
    {
        $data = [];

        $categoryId = $this->_helper->getSectionTwoCategory();
        if ($categoryId) {
            $pageSize = $this->getSectionTwoProductCount();
    ...
    {
        return $this->_helper->getSectionTwoProductCount();
    }
}
