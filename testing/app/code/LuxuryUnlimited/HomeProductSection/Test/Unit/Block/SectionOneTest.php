...
use LuxuryUnlimited\HomeProductSection\Block\SectionOne;
...
class SectionOneTest extends TestCase
{
    ...
    public function testGetSectionOneProductCollectionEmpty(): void
    {
        $this->helper->expects($this->once())
            ->method('getSectionOneCategory')
            ->willReturn('');
        $this->assertEmpty($this->object->getSectionOneProductCollection());
    }

    public function testGetSectionOneProductCollection(): void
    {
        $categoryId = 57;
        $pageSize = 5;
        ...
        $this->assertEquals($collectionMock, $this->object->getSectionOneProductCollection());
    }
    ...
    public function testSectionOneInstance(): void
    {
