...
namespace LuxuryUnlimited\SaleProducts\Helper;
...
class Data extends AbstractHelper
{
    ...
    public const IS_ENABLED_SALE_PRODUCTS = 'home_page/sale_products/enable';
    public const PRODUCT_DISPLAY_COUNT = 'home_page/sale_products/product_count';
    public const SALE_PRODUCTS_CATEGORY = 'home_page/sale_products/category';
    public const CRON_BATCH_COUNT = 'home_page/sale_products/cron_batch_count';
    public const OVER_ALL_COUNT = 'home_page/sale_products/overall_count';
    public const LAST_PROCESSED_PAGE = 'home_page/sale_products/last_processed_page';
    public const LAST_PROCESSED_DATE ='home_page/sale_products/last_processed_date';
    ...
    {
        return $this->getConfigValue(self::IS_ENABLED_SALE_PRODUCTS);
    }
     ...
     * @return string
     */
    public function getSaleProductsCategory()
    {
        return $this->getConfigValue(self::SALE_PRODUCTS_CATEGORY);
    }
     ...
     * @return string
     */
    public function getSaleProductsCronBatchCount()
    {
    ...
    public function getPreviousDate(): string
    {
        ...
        return $this->dateTime->date('Y-m-d', strtotime($date." -1 days"));
    }
     ...
     * @return void
     */
    public function assignProductToCategories($sku, $categoryIds): void
    {
     ...
     * @param String $path
     */
    public function getConfigCollection(string $path)
    {
