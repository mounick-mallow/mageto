...
define([
    ...
    'Addon_Attributeupload/js/form/element/abstract',
    ...
    return Element.extend({
        ...
        isFileAllowed: function (file) {
            ...
            _.every([
                ...
                this.isWidthHeightAllowed(file)
            ], function (value) {
                result = value;
        ...
        isExtensionAllowed: function (file) {
        	if(this.validation['validate-file-type'] != undefined || this.validation['validate-file-type'] != 'undefined'){
        		return validator('validate-file-type', file.name, this.validation['validate-file-type']);
        	}
        	return true;
        },
        /**
         * Checks if extension of provided file is width and height.
         *
         * @param {Object} file - File to be checked.
         * @returns {Boolean}
         */
        isWidthHeightAllowed: function (file) {

            return validator('validate-image-height-width',  this);
        },
        ...
        isSizeExceeded: function (file) {
        	...
        	if(this.validation['validate-max-size'] != undefined || this.validation['validate-max-size'] != 'undefined'){
        		return validator('validate-max-size', file.size, this.validation['validate-max-size']);
        	}
        	return true;
        ...
        onFilesChoosed: function (e, data) {
		    ...
		    var file, img;
		    window.uploadImageHeight = window.uploadImageWidth = false;
		    if ((file = data.files[0])) {
		        img = new Image();
		        img.onload = function() {
		        	window.uploadImageHeight = this.height;
		        	window.uploadImageWidth = this.width;
		        };
		        img.onerror = function(){
		        	window.uploadImageHeight = 0;
		        	window.uploadImageWidth = 0;
		        };
        ...
        waitTimer: function (){
            return window.uploadImageHeight !== false;
        },
        ...
        onBeforeFileUpload: function (e, data) {
        	if(this.waitTimer()){
        		...
        		var e = e;
        		var data = data;
        		setTimeout(function(){ mainThis.onBeforeFileUpload (e, data);}, 100);
