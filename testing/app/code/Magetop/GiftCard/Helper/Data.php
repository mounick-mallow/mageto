...
namespace Magetop\GiftCard\Helper;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     */
    protected $temp_id;
    public const XML_PATH_EMAIL_TEMPLATE_FIELD  = 'giftcard/email/gift_notification_mail';

    public const XML_PATH_GIFT_LEFT_AMT_EMAIL_TEMPLATE_FIELD  = 'giftcard/adminEmail/admin_amt_notification_mail';
    ...
    public function getRandId($length)
    {
        ...
        if ($length>0) {
            for ($i=1; $i<=$length; $i++) {
                mt_srand((double)microtime() * 1000000); // @codingStandardsIgnoreLine
                $num = mt_rand(1, 36); // @codingStandardsIgnoreLine
    ...
    public function getGiftCardActiveDuration()
    {
        return $this->getConfigValue(
            "giftcard/activeDuration/gift_admin_active_days",
