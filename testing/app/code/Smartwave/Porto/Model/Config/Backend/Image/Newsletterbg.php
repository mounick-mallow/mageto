 ...
 */
namespace Smartwave\Porto\Model\Config\Backend\Image;

use Magento\Config\Model\Config\Backend\Image;

/**
 * Class model Newsletterbg
 */
class Newsletterbg extends Image
{
    public const UPLOAD_DIR = 'porto/newsletter/background';
