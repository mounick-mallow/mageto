...
class BlockProductViewGallery
{
    ...
    */
    ...
    public function afterGetMagnifier(
        ...
        $decodedResult['enabled'] = $magnifierEnabled;
        $decodedResult['fullscreenzoom'] = $magnifierFullscreenzoom;
        $decodedResult['top'] = $magnifierTop;
        $decodedResult['left'] = $magnifierLeft;
        $decodedResult['width'] = $magnifierWidth;
        $decodedResult['height'] = $magnifierHeight;
        $decodedResult['eventType'] = $magnifierEventtype;

        return $this->jsonEncoder->encode($decodedResult);
    }
