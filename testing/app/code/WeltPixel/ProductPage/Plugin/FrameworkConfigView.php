        ...
        $mediaId)
    {
        ...
        if (($module == 'Magento_Catalog') && ($mediaType == Image::MEDIA_TYPE_CONFIG_NODE)) {
            ...
            if ($mediaId == 'product_page_image_small') {
                $width = $this->scopeConfig->getValue(self::XML_PATH_WELTPIXEL_PRODUCTPAGE_IMAGE_THUMB_WIDTH, \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
                $height = $this->scopeConfig->getValue(self::XML_PATH_WELTPIXEL_PRODUCTPAGE_IMAGE_THUMB_HEIGHT, \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
