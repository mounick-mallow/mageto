...
class LiquidFilters
{
    ...
    {
        $filters = [
            'replace' => ['label' => __('Replace'), 'params' => [
                ['label' => __('Search'), 'defVal' => ''],
                ['label' => __('Replace'), 'defVal' => '']]
            ],
            'replace_first' => ['label' => __('Replace First'), 'params' => [
                ['label' => __('Search'), 'defVal' => ''],
                ['label' => __('Replace'), 'defVal' => '']]
            ],
            'slice' => ['label' => __('Slice'), 'params' => [
                ['label' => __('From'), 'defVal' => ''],
                ['label' => __('To'), 'defVal' => '']]
            ],
            'truncate' => ['label' => __('Truncate'), 'params' => [
                ['label' => __('Count'), 'Chars' => ''],
                ['label' => __('Append Last'), 'defVal' => '']]
            ],
            'truncatewords' => ['label' => __('Truncate Words'), 'params' => [
    ...
    public function attrTempGoogle()
    {
        $attrTemplate = [
            ...
            'g:additional_image_link' => [
                'label' => __('g:additional_image_link'), 'value' => 'g:additional_image_link'],
            ...
            'g:google_product_category' => [
                'label' => __('g:google_product_category'), 'value' => 'g:google_product_category'],
