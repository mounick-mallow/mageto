...
class Data extends AbstractHelperAlias
{
    ...
    public function sendMail($generateMessage)
    {
        ...
        try {
            $transport = $this->transportBuilder->setTemplateIdentifier($mailTemplate == null ?
                "sendmail_mailsetting_template" : $mailTemplate)->setTemplateOptions(
                [
    ...
    public function getTemplateFacebook($feedData)
    {
        ...
        return [$templateHtml,$modifySeparate,$attributeValue];
    }
