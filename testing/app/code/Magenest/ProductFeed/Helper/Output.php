...
class Output extends AbstractHelper
{
    ...
    public function getPatternTypeOptions()
    {
        return [
            ...
            ['label' => 'Parent Product', 'value' => 'parent'],
            ['label' => 'Only Parent Product', 'value' => 'only_parent',],
     ...
     * @return array
     */
    public function getAttributeValues($attributeCode): array
    {
        $result = [];
        $attribute = $this->getAttribute($attributeCode);

        if (!empty($attribute) && $this->inSelect($attribute)) {
     ...
     * @return bool
     */
    public function inSelect($attribute): bool
    {
