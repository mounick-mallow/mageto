...
task('magento:deploy:assets', function() {
    run("cd {{release_or_current_path}} && sudo -u www-data php bin/magento setup:static-content:deploy -s standard -j16 -f --theme Magento/backend --theme LuxuryUnlimited/avoirchic --theme LuxuryUnlimited/avoirchic_rtl");
    echo "cd {{release_or_current_path}} && sudo -u www-data php bin/magento setup:static-content:deploy -s standard -j16 -f --theme Magento/backend --theme LuxuryUnlimited/avoirchic --theme LuxuryUnlimited/avoirchic_rtl";
});
