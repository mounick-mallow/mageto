...
namespace Deployer;
$REACT_THEME=get('labels')['reacttheme'];
...
task('deploy:magento-js-bundle', function() {
    run("cd {{release_or_current_path}} && magepack bundle -c magepack.config.${$REACT_THEME}.js");
});
...
task('magento:deploy:assets', function() {
    run("cd {{release_or_current_path}} && sudo -u www-data php bin/magento setup:static-content:deploy -s standard -j16 -f --theme Magento/backend --theme LuxuryUnlimited/veralusso");
