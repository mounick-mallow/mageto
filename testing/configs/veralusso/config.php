...
return [
    'modules' => [
        ...
        'Magento_TestModule1' => 1,
        'Magento_TestModule2' => 1,
        'Magento_TestModule3' => 1,
        'Magento_TestModule4' => 1,
        'Magento_TestModule5' => 1,
        'Magento_AdminAdobeIms' => 1,
        'Magento_TestModuleCatalogSearch' => 1,
        'Magento_TestModuleDefaultHydrator' => 1,
        'Magento_TestModuleFedex' => 1,
        'Magento_TestModuleGraphQlQuery' => 1,
        'Magento_TestModuleGraphQlQueryExtension' => 1,
        'Magento_TestModuleIntegrationFromConfig' => 1,
        'Magento_TestModuleJoinDirectives' => 1,
        'Magento_TestModuleMSC' => 1,
        'Magento_TestModuleOverrideConfig' => 1,
        'Magento_TestModuleOverrideConfig2' => 1,
        'Magento_TestModuleOverrideConfig3' => 1,
        'Magento_Ups' => 1,
        'Magento_TestModuleUsps' => 1,
        'Magento_AsynchronousOperations' => 1,
        'Magento_ThemeGraphQl' => 1,
        'Magento_Translation' => 1,
        'Magento_TwoFactorAuth' => 0,
        'Magento_GoogleOptimizer' => 1,
        'Magento_TestModuleUps' => 1,
        'Magento_SampleData' => 1,
        'Magento_CatalogUrlRewriteGraphQl' => 1,
        'Magento_TestModuleAdminAdobeIms' => 1,
        'Magento_Usps' => 1,
        ...
        'Addon_Attributeupload' => 1,
        'Adyen_Payment' => 1,
        'Ascure_Helperblock' => 1,
        'Aune_ProductGridCategoryFilter' => 0,
        'BelVG_GuestWishlist' => 1,
        'Ludxb_Continueshopping' => 1,
        'Belvg_QuickView' => 1,
        'Brainvire_AdminRolesApi' => 1,
        'Brainvire_CartCustomization' => 1,
        'Brainvire_Csp' => 1,
        'Brainvire_ErpCronLogs' => 1,
        'Bss_GeoIPAutoSwitchStore' => 1,
        'Bss_StoreviewFlags' => 1,
        'Custom_Accountinformation' => 1,
        'Custom_Catalog' => 1,
        'Custom_CustomOrderApi' => 1,
        'Custom_EstimatedDeliveryApi' => 1,
        'Custom_Field' => 1,
        'Custom_Navchange' => 1,
        'Custom_RedirectContactus' => 1,
        'Dynamic_Abandonedcartapi' => 1,
        'Dynamic_BrandsApi' => 1,
        'Dynamic_ContactformApi' => 1,
        'Dynamic_CronTime' => 1,
        'Dynamic_CustomerDataSync' => 1,
        'Dynamic_Customization' => 1,
        'Dynamic_HomepageApi' => 1,
        'Dynamic_LayeredApi' => 1,
        'Dynamic_Mytickets' => 1,
        'Dynamic_Notifyme' => 1,
        'Dynamic_OrderErpSync' => 1,
        'Dynamic_Orderreturn' => 1,
        'Dynamic_OrderStatus' => 1,
        'Dynamic_OrderTracking' => 1,
        'Dynamic_OrderHistory' => 1,
        'Dynamic_PriceComparison' => 1,
        'Dynamic_PriceConvert' => 1,
        'Dynamic_RecommendedApi' => 1,
        'Dynamic_Referfriend' => 1,
        'Dynamic_Returnstatus' => 1,
        'Dynamic_Shippinginfoapi' => 1,
        'Dynamic_SizeApi' => 1,
        'Dynamic_StoreCreditSync' => 1,
        'EthanYehuda_CronjobManager' => 1,
        'Ethnic_AdroidApp' => 1,
        'Ethnic_Base' => 1,
        'Ethnic_WishlistApi' => 1,
        'Firas_Cronbrands' => 1,
        'Firas_CustomApi' => 1,
        'Firas_DonationProduct' => 1,
        'Firas_FixProductBreadcrumbs' => 1,
        'Firas_FixSalesSequence' => 1,
        'Firas_Grid' => 1,
        'Firas_Ordersequence' => 1,
        'Firas_Price' => 1,
        'Firas_Simpleshipping' => 1,
        'Firas_Stockfeed' => 1,
        ...
        'LiveChat_LiveChat' => 0,
        'Local_Deploy' => 1,
        'Lof_WebPushNotification' => 1,
        'Belvg_ContinueLink' => 1,
        'LuxuryUnlimited_AjaxTrackOrder' => 1,
        'LuxuryUnlimited_AjaxWishList' => 1,
        'LuxuryUnlimited_AmastySorting' => 1,
        'LuxuryUnlimited_App' => 1,
        'Mage360_Brands' => 1,
        'LuxuryUnlimited_BrandsLabelAttribute' => 1,
        'LuxuryUnlimited_CmsSearch' => 1,
        'LuxuryUnlimited_Config' => 1,
        'LuxuryUnlimited_ConfigAPI' => 1,
        'LuxuryUnlimited_ConvertCurrencyCode' => 1,
        'LuxuryUnlimited_Coupon' => 1,
        'LuxuryUnlimited_CustomCategories' => 1,
        'LuxuryUnlimited_Customer' => 1,
        'LuxuryUnlimited_CustomerSigninExtend' => 1,
        'LuxuryUnlimited_FirstLogin' => 1,
        'LuxuryUnlimited_ForgotPasswordModification' => 1,
        'LuxuryUnlimited_FrontendConfigs' => 1,
        'LuxuryUnlimited_HomeApi' => 1,
        'LuxuryUnlimited_HomeCategorySection' => 1,
        'LuxuryUnlimited_HomeProductSection' => 1,
        'Shellpea_ERP' => 1,
        'LuxuryUnlimited_MostPopular' => 1,
        'LuxuryUnlimited_MyReturnsApi' => 1,
        'LuxuryUnlimited_NewsLetterSubscription' => 1,
        'LuxuryUnlimited_OrderApi' => 1,
        'LuxuryUnlimited_OrderTracking' => 1,
        'LuxuryUnlimited_ProductOutOfStock' => 1,
        'LuxuryUnlimited_QuoteApi' => 1,
        'LuxuryUnlimited_QuoteProductImage' => 1,
        'LuxuryUnlimited_SaleProducts' => 1,
        'LuxuryUnlimited_Sales' => 1,
        'LuxuryUnlimited_SizeAttribute' => 1,
        'LuxuryUnlimited_SmileElasticSuite' => 1,
        'LuxuryUnlimited_SocialLogin' => 1,
        'LuxuryUnlimited_Store' => 1,
        'LuxuryUnlimited_StoreSwitcher' => 1,
        'LuxuryUnlimited_TrackCmsPages' => 1,
        'LuxuryUnlimited_TranslateBlocks' => 1,
        'LuxuryUnlimited_WorkerStores' => 1,
        'LuxuryUnlimited_BrandList' => 1,
        'MagePal_GmailSmtpApp' => 1,
        'MageSuite_Magepack' => 1,
        'MageWorx_Info' => 1,
        'MageWorx_SearchSuiteAutocomplete' => 1,
        'Magentizer_Erpservices' => 1,
        'Magentizer_GeoIP' => 0,
        'Magentizer_Pricing' => 1,
        'Mageplaza_Core' => 1,
        ...
        'Magepow_Core' => 1,
        'Magetop_GiftCard' => 1,
        'Magetracer_StoreOptimization' => 1,
        'MaxMage_InternationalTelephoneInput' => 1,
        'Meetanshi_DeferJS' => 1,
        'Meetanshi_SavedCards' => 1,
        'MultiStoreRestApi_StoreProductsRestApi' => 1,
        'OlegKoval_RegenerateUrlRewrites' => 1,
        'PayPal_Braintree' => 0,
        'PayPal_BraintreeGraphQl' => 0,
        'Phpro_CookieConsent' => 1,
        'Plumrocket_Base' => 1,
        'Plumrocket_SocialLoginFree' => 1,
        'Shellpea_Catalog' => 1,
        'LuxuryUnlimited_InfluencerRegistration' => 1,
        'LuxuryUnlimited_EligibilityCheck' => 1,
        'Shellpea_GuestWishlist' => 1,
        'Shellpea_ReactCheckout' => 1,
        'Shellpea_RemoveMegamenuAttributes' => 1,
        'Shellpea_SalesRules' => 1,
        ...
        'Sololuxury_BuyNow' => 1,
        'Sparsh_Faq' => 1,
        'StoreRestApi_CustomRestApi' => 1,
        'Strategery_Infinitescroll' => 1,
        'Swarming_StoreCredit' => 1,
        ...
        'Zealousweb_AppleLogin' => 1
    ],
    'system' => [
        'default' => [
            'currency' => [
                'options' => [
                    'allow' => 'ALL,ARS,AMD,AWG,AUD,BSD,BHD,BBD,BYR,BOB,BWP,BRL,GBP,BGN,CAD,CLP,CNY,COP,CRC,HRK,CZK,DKK,EGP,EUR,GEL,GHS,GTQ,HNL,HKD,HUF,ISK,INR,IDR,ILS,JPY,JOD,KZT,KES,KWD,MGA,MYR,MVR,MUR,MXN,MDL,MNT,MAD,NAD,NPR,NZD,NIC,NGN,NOK,OMR,PKR,PGK,PYG,PEN,PHP,PLN,QAR,RON,RUB,RWF,SAR,SCR,SGD,ZAR,KRW,SEK,CHF,TZS,THB,TTD,TND,TRY,USD,UGX,UAH,AED,UYU,VEF,VND,ZMK,ZWD',
                    'base' => 'EUR',
                    'default' => 'EUR'
                ],
                'import' => [
